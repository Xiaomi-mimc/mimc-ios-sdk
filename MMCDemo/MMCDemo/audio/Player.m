...
- (instancetype)init {
    ...
    if (self) {
        ...
        for (int i = 0; i < QUEUE_BUFFER_SIZE; i++) {
            ...
            osState = AudioQueueAllocateBuffer(audioQueue, kDefaultBufferSize, &audioQueueBuffers[i]);
            NSLog(@"AudioQueueAllocateBuffer, osState=%d", (int)osState);
        }
...
static void AudioPlayerAQInputCallback(void* inUserData,AudioQueueRef audioQueueRef, AudioQueueBufferRef audioQueueBufferRef) {
    Player *player = (__bridge Player*)inUserData;
